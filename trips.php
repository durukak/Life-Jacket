...
$sql2 = "select tripID, locat from trip order by tripID asc limit $currentpagenum,5"; // display 10 posts in page
$res2 = $con->query($sql2);
$num2 = (($page - 1) * 5) + 1;
?>
<?php
    ...
    while ($row = mysqli_fetch_array($res2)) {
        ...
        ?>
         ...
         <tr style="cursor: pointer;"
            ...
            <th style="text-align: center;"><?php if(mb_strlen($row['locat'],"utf-8") > 30) {echo $title;} else {echo $title2;}?></th>
         </tr>
  <?php
...
<div class="header_top_section">
  ...
  <?php } ?> 
      ...
      <button style="float: right; border: transparent; background-color: black; color: white" class="btn-btn-default"
         onclick="location.href='tripwrite.php'">Add trip</button>
   </div>
</body>
</html>
