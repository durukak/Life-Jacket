...
<div class="header_top_section">
   <div class="container">
      ...
      <button class="btn btn-default btn-sm btn-block" style="font-size: 20px; font-weight: bolder;" onclick="apply();">UPDATE</button>
   </div>
   </div>
                        </div>
                      </div>
   ...
   <script>
        function apply(){
            ...
            obj = {"table":"trip","locat":x1,"descr":x2,"numVolunteers":x3,"crisis":x4,"tripDate":x5, "tripID":"<?php echo $tripID; ?>"};
            ...
            xmlhttp.onreadystatechange = function(){
                ...
                if((x2.trim() == "<br>"||x2.trim()=="")||(x1.trim() == "")) {
                    ...
                    xmlhttp.open("POST","tripupdateapply.php",true);
